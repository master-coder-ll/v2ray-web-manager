## 新手教程-Ubuntu16.04-安装
  ...
  4. 下载文件releases文件
     ...
     # wget -c https://github.com/master-coder-ll/v2ray-web-manager/releases/download/v2.1/admin-1.0.jar
     # wget -c https://github.com/master-coder-ll/v2ray-web-manager/releases/download/v2.0-beta/dist.zip   
     # wget -c https://github.com/master-coder-ll/v2ray-web-manager/releases/download/v2.1/v2ray-proxy-1.0.jar
