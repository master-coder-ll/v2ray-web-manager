...
func init() {
	proto.RegisterType((*Config)(nil), "com.core.app.log.command.Config")
	proto.RegisterType((*RestartLoggerRequest)(nil), "com.core.app.log.command.RestartLoggerRequest")
	proto.RegisterType((*RestartLoggerResponse)(nil), "com.core.app.log.command.RestartLoggerResponse")
}
...
func (c *loggerServiceClient) RestartLogger(ctx context.Context, in *RestartLoggerRequest, opts ...grpc.CallOption) (*RestartLoggerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/com.core.app.log.command.LoggerService/RestartLogger", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LoggerService_RestartLogger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.core.app.log.command.LoggerService/RestartLogger",
	}
...
var _LoggerService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.core.app.log.command.LoggerService",
