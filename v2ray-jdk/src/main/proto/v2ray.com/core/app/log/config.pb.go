...
type Config struct {
	ErrorLogType         LogType      `protobuf:"varint,1,opt,name=error_log_type,json=errorLogType,enum=com.core.app.log.LogType" json:"error_log_type,omitempty"`
	ErrorLogLevel        log.Severity `protobuf:"varint,2,opt,name=error_log_level,json=errorLogLevel,enum=com.core.common.log.Severity" json:"error_log_level,omitempty"`
	ErrorLogPath         string       `protobuf:"bytes,3,opt,name=error_log_path,json=errorLogPath" json:"error_log_path,omitempty"`
	AccessLogType        LogType      `protobuf:"varint,4,opt,name=access_log_type,json=accessLogType,enum=com.core.app.log.LogType" json:"access_log_type,omitempty"`
...
func init() {
	proto.RegisterType((*Config)(nil), "com.core.app.log.Config")
	proto.RegisterEnum("com.core.app.log.LogType", LogType_name, LogType_value)
}
