...
type AllocationStrategy struct {
	Type AllocationStrategy_Type `protobuf:"varint,1,opt,name=type,enum=com.core.app.proxyman.AllocationStrategy_Type" json:"type,omitempty"`
...
type ReceiverConfig struct {
	...
	DomainOverride             []KnownProtocols       `protobuf:"varint,7,rep,packed,name=domain_override,json=domainOverride,enum=com.core.app.proxyman.KnownProtocols" json:"domain_override,omitempty"`
	XXX_NoUnkeyedLiteral       struct{}               `json:"-"`
	XXX_unrecognized           []byte                 `json:"-"`
	XXX_sizecache              int32                  `json:"-"`
}
...
func init() {
	proto.RegisterType((*InboundConfig)(nil), "com.core.app.proxyman.InboundConfig")
	proto.RegisterType((*AllocationStrategy)(nil), "com.core.app.proxyman.AllocationStrategy")
	proto.RegisterType((*AllocationStrategy_AllocationStrategyConcurrency)(nil), "com.core.app.proxyman.AllocationStrategy.AllocationStrategyConcurrency")
	proto.RegisterType((*AllocationStrategy_AllocationStrategyRefresh)(nil), "com.core.app.proxyman.AllocationStrategy.AllocationStrategyRefresh")
	proto.RegisterType((*ReceiverConfig)(nil), "com.core.app.proxyman.ReceiverConfig")
	proto.RegisterType((*InboundHandlerConfig)(nil), "com.core.app.proxyman.InboundHandlerConfig")
	proto.RegisterType((*OutboundConfig)(nil), "com.core.app.proxyman.OutboundConfig")
	proto.RegisterType((*SenderConfig)(nil), "com.core.app.proxyman.SenderConfig")
	proto.RegisterType((*MultiplexingConfig)(nil), "com.core.app.proxyman.MultiplexingConfig")
	proto.RegisterEnum("com.core.app.proxyman.KnownProtocols", KnownProtocols_name, KnownProtocols_value)
	proto.RegisterEnum("com.core.app.proxyman.AllocationStrategy_Type", AllocationStrategy_Type_name, AllocationStrategy_Type_value)
}
