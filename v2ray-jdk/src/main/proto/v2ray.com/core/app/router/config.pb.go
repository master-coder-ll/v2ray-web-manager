...
type Domain struct {
	...
	Type Domain_Type `protobuf:"varint,1,opt,name=type,enum=com.core.app.router.Domain_Type" json:"type,omitempty"`
	// Domain value.
...
type Config struct {
	DomainStrategy       Config_DomainStrategy `protobuf:"varint,1,opt,name=domain_strategy,json=domainStrategy,enum=com.core.app.router.Config_DomainStrategy" json:"domain_strategy,omitempty"`
...
func init() {
	proto.RegisterType((*Domain)(nil), "com.core.app.router.Domain")
	proto.RegisterType((*CIDR)(nil), "com.core.app.router.CIDR")
	proto.RegisterType((*GeoIP)(nil), "com.core.app.router.GeoIP")
	proto.RegisterType((*GeoIPList)(nil), "com.core.app.router.GeoIPList")
	proto.RegisterType((*GeoSite)(nil), "com.core.app.router.GeoSite")
	proto.RegisterType((*GeoSiteList)(nil), "com.core.app.router.GeoSiteList")
	proto.RegisterType((*RoutingRule)(nil), "com.core.app.router.RoutingRule")
	proto.RegisterType((*Config)(nil), "com.core.app.router.Config")
	proto.RegisterEnum("com.core.app.router.Domain_Type", Domain_Type_name, Domain_Type_value)
	proto.RegisterEnum("com.core.app.router.Config_DomainStrategy", Config_DomainStrategy_name, Config_DomainStrategy_value)
}
