...
func init() {
	proto.RegisterType((*GetStatsRequest)(nil), "com.core.app.stats.command.GetStatsRequest")
	proto.RegisterType((*Stat)(nil), "com.core.app.stats.command.Stat")
	proto.RegisterType((*GetStatsResponse)(nil), "com.core.app.stats.command.GetStatsResponse")
	proto.RegisterType((*Config)(nil), "com.core.app.stats.command.Config")
}
...
func (c *statsServiceClient) GetStats(ctx context.Context, in *GetStatsRequest, opts ...grpc.CallOption) (*GetStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/com.core.app.stats.command.StatsService/GetStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StatsService_GetStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.core.app.stats.command.StatsService/GetStats",
	}
...
var _StatsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "com.core.app.stats.command.StatsService",
