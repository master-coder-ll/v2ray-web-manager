...
type Endpoint struct {
	Network              Network     `protobuf:"varint,1,opt,name=network,enum=com.core.common.net.Network" json:"network,omitempty"`
...
func init() {
	proto.RegisterType((*Endpoint)(nil), "com.core.common.net.Endpoint")
}
