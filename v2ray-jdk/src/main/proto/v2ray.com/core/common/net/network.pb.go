...
type NetworkList struct {
	Network              []Network `protobuf:"varint,1,rep,packed,name=network,enum=com.core.common.net.Network" json:"network,omitempty"`
...
func init() {
	proto.RegisterType((*NetworkList)(nil), "com.core.common.net.NetworkList")
	proto.RegisterEnum("com.core.common.net.Network", Network_name, Network_value)
}
