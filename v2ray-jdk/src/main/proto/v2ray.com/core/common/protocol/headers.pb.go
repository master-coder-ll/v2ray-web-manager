...
type SecurityConfig struct {
	Type                 SecurityType `protobuf:"varint,1,opt,name=type,enum=com.core.common.protocol.SecurityType" json:"type,omitempty"`
...
func init() {
	proto.RegisterType((*SecurityConfig)(nil), "com.core.common.protocol.SecurityConfig")
	proto.RegisterEnum("com.core.common.protocol.SecurityType", SecurityType_name, SecurityType_value)
}
