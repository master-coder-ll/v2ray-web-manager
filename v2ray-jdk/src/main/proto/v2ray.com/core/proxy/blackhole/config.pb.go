...
func init() {
	proto.RegisterType((*NoneResponse)(nil), "com.core.proxy.blackhole.NoneResponse")
	proto.RegisterType((*HTTPResponse)(nil), "com.core.proxy.blackhole.HTTPResponse")
	proto.RegisterType((*Config)(nil), "com.core.proxy.blackhole.Config")
}
