...
type Config struct {
	DomainStrategy       Config_DomainStrategy `protobuf:"varint,1,opt,name=domain_strategy,json=domainStrategy,enum=com.core.proxy.freedom.Config_DomainStrategy" json:"domain_strategy,omitempty"`
...
func init() {
	proto.RegisterType((*DestinationOverride)(nil), "com.core.proxy.freedom.DestinationOverride")
	proto.RegisterType((*Config)(nil), "com.core.proxy.freedom.Config")
	proto.RegisterEnum("com.core.proxy.freedom.Config_DomainStrategy", Config_DomainStrategy_name, Config_DomainStrategy_value)
}
