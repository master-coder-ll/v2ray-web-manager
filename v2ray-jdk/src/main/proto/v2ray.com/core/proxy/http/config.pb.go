...
func init() {
	proto.RegisterType((*ServerConfig)(nil), "com.core.proxy.http.ServerConfig")
	proto.RegisterMapType((map[string]string)(nil), "com.core.proxy.http.ServerConfig.AccountsEntry")
	proto.RegisterType((*ClientConfig)(nil), "com.core.proxy.http.ClientConfig")
}
