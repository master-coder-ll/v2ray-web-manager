...
type Account struct {
	...
	CipherType           CipherType          `protobuf:"varint,2,opt,name=cipher_type,json=cipherType,enum=com.core.proxy.shadowsocks.CipherType" json:"cipher_type,omitempty"`
	Ota                  Account_OneTimeAuth `protobuf:"varint,3,opt,name=ota,enum=com.core.proxy.shadowsocks.Account_OneTimeAuth" json:"ota,omitempty"`
...
type ServerConfig struct {
	...
	Network              []net.Network  `protobuf:"varint,3,rep,packed,name=network,enum=com.core.common.net.Network" json:"network,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func init() {
	proto.RegisterType((*Account)(nil), "com.core.proxy.shadowsocks.Account")
	proto.RegisterType((*ServerConfig)(nil), "com.core.proxy.shadowsocks.ServerConfig")
	proto.RegisterType((*ClientConfig)(nil), "com.core.proxy.shadowsocks.ClientConfig")
	proto.RegisterEnum("com.core.proxy.shadowsocks.CipherType", CipherType_name, CipherType_value)
	proto.RegisterEnum("com.core.proxy.shadowsocks.Account_OneTimeAuth", Account_OneTimeAuth_name, Account_OneTimeAuth_value)
}
