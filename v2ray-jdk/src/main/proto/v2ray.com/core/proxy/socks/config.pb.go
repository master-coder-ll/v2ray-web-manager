...
type ServerConfig struct {
	AuthType             AuthType          `protobuf:"varint,1,opt,name=auth_type,json=authType,enum=com.core.proxy.socks.AuthType" json:"auth_type,omitempty"`
...
func init() {
	proto.RegisterType((*Account)(nil), "com.core.proxy.socks.Account")
	proto.RegisterType((*ServerConfig)(nil), "com.core.proxy.socks.ServerConfig")
	proto.RegisterMapType((map[string]string)(nil), "com.core.proxy.socks.ServerConfig.AccountsEntry")
	proto.RegisterType((*ClientConfig)(nil), "com.core.proxy.socks.ClientConfig")
	proto.RegisterEnum("com.core.proxy.socks.AuthType", AuthType_name, AuthType_value)
}
