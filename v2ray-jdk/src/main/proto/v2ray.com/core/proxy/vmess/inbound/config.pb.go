...
func init() {
	proto.RegisterType((*DetourConfig)(nil), "com.core.proxy.vmess.inbound.DetourConfig")
	proto.RegisterType((*DefaultConfig)(nil), "com.core.proxy.vmess.inbound.DefaultConfig")
	proto.RegisterType((*Config)(nil), "com.core.proxy.vmess.inbound.Config")
}
