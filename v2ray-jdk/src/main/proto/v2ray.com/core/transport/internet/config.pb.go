...
type TransportConfig struct {
	...
	Protocol TransportProtocol `protobuf:"varint,1,opt,name=protocol,enum=com.core.transport.internet.TransportProtocol" json:"protocol,omitempty"`
...
func init() {
	proto.RegisterType((*TransportConfig)(nil), "com.core.transport.internet.TransportConfig")
	proto.RegisterType((*StreamConfig)(nil), "com.core.transport.internet.StreamConfig")
	proto.RegisterType((*ProxyConfig)(nil), "com.core.transport.internet.ProxyConfig")
	proto.RegisterEnum("com.core.transport.internet.TransportProtocol", TransportProtocol_name, TransportProtocol_value)
}
