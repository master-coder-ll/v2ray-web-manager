...
func init() {
	proto.RegisterType((*Config)(nil), "com.core.transport.internet.headers.noop.Config")
	proto.RegisterType((*ConnectionConfig)(nil), "com.core.transport.internet.headers.noop.ConnectionConfig")
}
