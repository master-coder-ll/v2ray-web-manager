...
type Certificate struct {
	...
	Usage                Certificate_Usage `protobuf:"varint,3,opt,name=usage,enum=com.core.transport.internet.tls.Certificate_Usage" json:"usage,omitempty"`
...
func init() {
	proto.RegisterType((*Certificate)(nil), "com.core.transport.internet.tls.Certificate")
	proto.RegisterType((*Config)(nil), "com.core.transport.internet.tls.Config")
	proto.RegisterEnum("com.core.transport.internet.tls.Certificate_Usage", Certificate_Usage_name, Certificate_Usage_value)
}
